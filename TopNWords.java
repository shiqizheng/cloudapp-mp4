...
public class TopNFinderBolt extends BaseBasicBolt {
 ...
 /*
    ...
    ------------------------------------------------- */
     ...
     Integer count = currentTopWords.get(word);
     currentTopWords.put(word, count);
//     if(currentTopWords.size()> N) {
//             currentTopWords.remove(currentTopWords.first());
//       }

//     for(<String,Integer> item: currentTopWords){
/      word=currentTopWords.first();
//      count=currentTopWords.second();
